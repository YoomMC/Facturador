...
def main(page: ft.Page):    
    ...
    Boton_Generar_factura=ft.ElevatedButton("Generar Factura",width=160,height=35,bgcolor=ft.colors.INDIGO_600,color=ft.colors.WHITE,on_click=lambda _: pick_files_dialog_2.pick_files(allow_multiple=False))
