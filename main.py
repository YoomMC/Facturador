...
class TodoApp(ft.UserControl):
    def build(self):
        ...
        self.new_task = ft.TextField(hint_text="Escriba el id del producto", expand=True,on_submit=self.add_clicked)
...
def main(page: ft.Page):    
    ...
    #!Campos a llenar y funcion de botones
    def Boton_Eliminar_Datos_logica(a):
        Cedula.value=""
        Cedula.read_only=False
        Nombre_Cliente.value=""
        Nombre_Cliente.read_only=False
        Apeliido_Usuaio.value=""
        Apeliido_Usuaio.read_only=False
        Mail.value=""
        Mail.read_only=False
        Direccion.value=""
        Direccion.read_only=False
        Telefono.value=""
        Telefono.read_only=False
        Cedula.focus()
        page.update()

    def Boton_Consumidor_final_logica(e):
        Cedula.value="**********"
        Cedula.read_only=True
        Nombre_Cliente.value="*****************"
        Nombre_Cliente.read_only=True
        Apeliido_Usuaio.value="****************"
        Apeliido_Usuaio.read_only=True
        Mail.value="**************"
        Mail.read_only=True
        Direccion.value="************"
        Direccion.read_only=True
        Telefono.value="************"
    ...
    Cedula=ft.TextField(label="Cedula",width=430,height=65,max_length=10,hint_text=("Ejm:1750395012"))
    ...
    greetings = ft.Column()
    #!Botones
    Boton_buscar_cedula= ft.ElevatedButton(text=("Buscar"), icon=ft.icons.SEARCH,height=65,bgcolor=ft.colors.BLUE_500,color="WHITE")
    Boton_consumirdor_final=ft.ElevatedButton("Consumidor final",width=165,height=35,bgcolor=ft.colors.GREEN_500,color="WHITE",on_click=Boton_Consumidor_final_logica)
    Boton_Generar_factura=ft.ElevatedButton("Generar Factura",width=160,height=35,bgcolor=ft.colors.INDIGO_600,color=ft.colors.WHITE,)
    Boton_Eliminar_Datos=ft.ElevatedButton("Eliminar Datos",width=150,height=35,bgcolor=ft.colors.RED,color=ft.colors.WHITE,on_click=Boton_Eliminar_Datos_logica)

    #!Totales
    sub_total=ft.Text("VACIO",size=15)
    total_iva=ft.Text("Vacio",size=15)
    total=ft.Text("VACIO",size=15)



    #!Campos del login
    
    Login_Usuario=ft.TextField(label="Usuario",width=550,height=70, autofocus=True,prefix_icon=ft.icons.PERSON_OUTLINED)
    Registrar = ft.Column()
    Login_Pasword=ft.TextField(label="Contraseña",width=550,height=70,password=True,can_reveal_password=True,prefix_icon=ft.icons.VPN_KEY_OUTLINED )
    ...
    #!Campo para cambiar la foto de Empresa
    Foto_agregar_imaagen=ft.Image(
        src=f"baja_calida.jpg",
    )

    def on_imagen_empresa(e: ft.FilePickerResultEvent):
        global img_path
        img_path = e.files[0].path
        Foto_agregar_imaagen.src = img_path
        # Borrar la lista de controles antes de añadir la nueva imagen
        page.update()
    pick_files_dialog_2 = ft.FilePicker(on_result=on_imagen_empresa)
    page.overlay.append(pick_files_dialog_2)
    #!============------------------ALERTAS--------------------=================
                        ...
                        [
                            ft.Row(
                                [
                                    ...
                                    ft.Text("Configuraciones",size=30),
                                ]
                            ),
                            ft.Divider(height=10),
                        ]
                ...
                ft.Card(
                    ...
                    content=ft.Container(
                        ...
                        content=ft.Column(
                            [
                                ft.ListTile(
                                    title=ft.Text("Ajustes de Billify"),
                                ),
                                ft.ListTile(
                                    leading=ft.Text("   ",size=10),
                                    title=ft.Text("Cambiar Tema claro/oscuro"),
                                ),
                                ft.RadioGroup(content=ft.Column([
                                    ft.Radio(value="Modo Oscuro",label="Modo Oscuro"),
                                    ft.Radio(value="Modo claro", label="Modo claro")]), on_change=radiogroup_changed),
                                ft.ListTile(
                                    leading=ft.Icon(ft.icons.SETTINGS),
                                    title=ft.Text("Cambio de campos de la empresa"),
                                ),
                                ft.ListTile(
                                    leading=ft.Text("   ",size=10),
                                    title=ft.Text("Cambiar nombre de empresa o slogan"),
                                    selected=True,
                                    on_click=theme,
                                ),
                                ft.ListTile(
                                    leading=ft.Text("   "),
                                    title=ft.Text("Cambiar logo de la empresa"),
                                    selected=True,
        ...
        [   
            ft.Column(
                [
                    ...
                    ft.Row(controls=[Cedula,Boton_buscar_cedula]),
            ...
            [
                ft.Row(
                    [
                        ...
                        ft.VerticalDivider(color="BLUE",width=5),
                        ft.Container(
                            width=550,
                            height=615,
                            padding=1,
                                                            ...
                                                            ft.Container(
                                                                ...
                                                                content=ft.Row(
                                                                    [
                                                                        ft.Column(
                                                                            [
                                                                                ft.Row([ft.Text("Subtotal:",size=15)]),
                                                                                ft.Row([ft.Text("IVA%:",size=15)]),
                                                                                ft.Row([ft.Text("TOTAL:",size=15)]),
                                                                            ]
                                                                        ),
                                                                        ft.VerticalDivider(),
                                                                        ft.Column(
                                                                            [
                                                                                sub_total,total_iva,total
                                                                            ]
                                                                        ),
                                                                    ]
                                                                )
